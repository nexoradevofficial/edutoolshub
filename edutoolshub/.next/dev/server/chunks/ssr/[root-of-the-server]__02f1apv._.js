...
"[project]/src/lib/sanity-image.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "buildImageUrl",
    ()=>buildImageUrl,
    "enrichPostsForInsightSlide",
    ()=>enrichPostsForInsightSlide
]);
...
function getBuilder() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$image$2d$url$2f$lib$2f$_chunks$2d$es$2f$compat$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createImageUrlBuilder"])({
        projectId,
...
function buildImageUrl(source, { width, height, fit = "crop" } = {}) {
...
function enrichPostsForInsightSlide(posts) {
    if (!Array.isArray(posts)) return [];
    const builder = getBuilder();
    if (!builder) return posts;
    return posts.map((post)=>{
        if (!post?.mainImage?.asset) return post;
        const src = buildImageUrl(post.mainImage, {
            width: 800,
            height: 1000
        });
        const srcSet = [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanity$2d$image$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/sanity-image.js [app-rsc] (ecmascript)");
...
async function HomePage() {
    ...
    try {
        ...
        const raw = await client.fetch(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$queries$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["recentPostsQuery"]);
        recentPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanity$2d$image$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["enrichPostsForInsightSlide"])(raw);
    } catch  {
        recentPosts = [];
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02f1apv._.js.map