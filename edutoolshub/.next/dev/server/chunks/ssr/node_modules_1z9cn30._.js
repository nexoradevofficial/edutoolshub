...
function clientConfigToOptions(config) {
    ...
    if (resource?.type === "canvas") {
        if (typeof resource.id != "string" || resource.id.length === 0) throw new Error('Canvas clients must include an id in "resource"');
        return {
            ...baseOptions,
            canvasId: resource.id
        };
    }
    if (resource?.type === "dataset") {
        if (typeof resource.id != "string" || resource.id.length === 0) throw new Error('Dataset clients must include an id in "resource"');
        const [resourceProjectId, resourceDataset] = resource.id.split(".");
        if (!resourceProjectId || !resourceDataset) throw new Error('Dataset resource id must be in the format "projectId.dataset", got: ' + resource.id);
        return {
            ...baseOptions,
...
class ImageUrlBuilderImpl {
    ...
    withClient(client) {
        ...
        return delete preservedOptions.baseUrl, delete preservedOptions.projectId, delete preservedOptions.dataset, delete preservedOptions.mediaLibraryId, delete preservedOptions.canvasId, new ImageUrlBuilderImpl(null, {
            ...newOptions,
            ...preservedOptions
        });
    }
...
function n(s, i) {
    const u = [], a = o.reduce((e, r)=>(e[r] = e[r] || [], e), {
        processOptions: [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$_chunks$2d$es$2f$_commonjsHelpers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["p"]
        ],
        validateOptions: [
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$get$2d$it$2f$dist$2f$_chunks$2d$es$2f$_commonjsHelpers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["v"]
        ]
    });
    function c(e) {
        const r = t.reduce((e, r)=>(e[r] = function() {
                const e = /* @__PURE__ */ Object.create(null);
                let r = 0;
                return {
                    publish: function(r) {
                        for(const t in e)e[t](r);
                    },
            ...
            }(), e), {}), o = ((e)=>function(r, t, ...o) {
                const n = "onError" === r;
                let s = t;
                for(let t = 0; t < e[r].length && (s = (0, e[r][t])(s, ...o), !n || s); t++);
                return s;
        ...
        const c = r.request.subscribe((e)=>{
            u = i(e, (t, n)=>((e, t, n)=>{
                    ...
                    s = s && o("onError", s, n), s ? r.error.publish(s) : i && r.response.publish(i);
                })(t, n, e));
        });
        r.abort.subscribe(()=>{
            c(), u && u.abort();
        });
        const l = o("onReturn", r, s);
        return l === r && r.request.publish(s), l;
    }
...
function extractErrorProps(res, context) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$client$2f$dist$2f$_chunks$2d$es$2f$stegaClean$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isRecord"])(body)) return props.message = `${httpErrorMessage(res, body)}${formatTraceId(props.traceId)}`, props;
...
//# sourceMappingURL=node_modules_1z9cn30._.js.map