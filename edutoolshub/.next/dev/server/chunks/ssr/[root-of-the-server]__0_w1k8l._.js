...
"[project]/src/lib/env.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/sanity/client.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/env.js [app-ssr] (ecmascript)");
;
;
const projectId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanityProjectId"])();
const dataset = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$env$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanityDataset"])();
...
"[project]/src/sanity/image.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/sanity/client.js [app-ssr] (ecmascript)");
;
;
const builder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$image$2d$url$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$client$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanityClient"]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/sanity/image.js [app-ssr] (ecmascript)");
...
function InsightSlide({ post }) {
    ...
    if (!href) return null;
    const imageSrc = mainImage ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlFor"])(mainImage).width(800).height(1000).fit("crop").auto("format").url() : null;
    const imageSrcSet = mainImage ? [
        `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlFor"])(mainImage).width(500).height(625).fit("crop").auto("format").url()} 500w`,
        `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlFor"])(mainImage).width(800).height(1000).fit("crop").auto("format").url()} 800w`,
        `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$sanity$2f$image$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["urlFor"])(mainImage).width(1100).height(1375).fit("crop").auto("format").url()} 1100w`
    ].join(", ") : undefined;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_w1k8l._.js.map