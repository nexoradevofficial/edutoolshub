...
import ToolAudienceBadge from "./tools/ToolAudienceBadge";
    ...
    return (
      ...
      >
        <div className="absolute right-4 top-4 flex flex-col items-end gap-2">
          ...
          {tool.audience ? <ToolAudienceBadge audience={tool.audience} /> : null}
        </div>
        <div
        ...
        <h3 className="mt-4 pr-20 text-lg font-semibold text-text group-hover:text-primary transition-colors">
          {tool.name}
        </h3>
  ...
  return (
    ...
    >
      <span className="absolute right-4 top-4 flex flex-col items-end gap-2">
        <span className="inline-flex items-center gap-1 rounded-full bg-slate-200 px-2.5 py-1 text-xs font-medium text-slate-500">
